...
static int hx8399c_auo_53_on(struct hx8399c_auo_53 *ctx)
{
	...
	dsi_generic_write_seq(dsi, 0xb9, 0xff, 0x83, 0x99);
	dsi_generic_write_seq(dsi, 0xb1,
			      0x02, 0x04, 0x6c, 0x8c, 0x01, 0x32, 0x33, 0x11,
			      0x11, 0x4d, 0x52, 0x56, 0x73, 0x02, 0x02);
	dsi_generic_write_seq(dsi, 0xb2,
			      0x00, 0x80, 0x80, 0xae, 0x05, 0x07, 0x5a, 0x11,
			      0x10, 0x10, 0x00, 0x1e, 0x70, 0x03, 0xd4);
	dsi_generic_write_seq(dsi, 0xb4,
			      0x00, 0xff, 0x56, 0x3c, 0x00, 0xab, 0x00, 0x00,
			      0x04, 0x00, 0x00, 0x02, 0x00, 0x2a, 0x02, 0x07,
			      0x09, 0x21, 0x03, 0x01, 0x00, 0x00, 0xac, 0x84,
			      0x56, 0x3c, 0x00, 0xab, 0x00, 0x00, 0x04, 0x00,
			      0x00, 0x02, 0x00, 0x2a, 0x02, 0x07, 0x09, 0x01,
			      0x00, 0x00, 0xac, 0x12);
	dsi_generic_write_seq(dsi, 0xd3,
			      0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x10, 0x10,
			      0x00, 0x00, 0x03, 0x00, 0x03, 0x00, 0x07, 0x88,
			      0x07, 0x88, 0x00, 0x00, 0x00, 0x00, 0x00, 0x24,
			      0x02, 0x05, 0x05, 0x03, 0x00, 0x00, 0x00, 0x05,
			      0x40);
	dsi_generic_write_seq(dsi, 0xd5,
			      0x20, 0x20, 0x19, 0x19, 0x18, 0x18, 0x02, 0x03,
			      0x00, 0x01, 0x24, 0x24, 0x18, 0x18, 0x18, 0x18,
			      0x24, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			      0x00, 0x00, 0x2f, 0x2f, 0x30, 0x30, 0x31, 0x31);
	dsi_generic_write_seq(dsi, 0xd6,
			      0x24, 0x24, 0x18, 0x18, 0x19, 0x19, 0x01, 0x00,
			      0x03, 0x02, 0x24, 0x24, 0x18, 0x18, 0x18, 0x18,
			      0x20, 0x20, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40,
			      0x40, 0x40, 0x2f, 0x2f, 0x30, 0x30, 0x31, 0x31);
	dsi_generic_write_seq(dsi, 0xd8,
			      0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
			      0xaa, 0xba, 0xaa, 0xaa, 0xaa, 0xba, 0xaa, 0xaa);
	dsi_generic_write_seq(dsi, 0xbd, 0x01);
	dsi_generic_write_seq(dsi, 0xd8,
			      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			      0x82, 0xea, 0xaa, 0xaa, 0x82, 0xea, 0xaa, 0xaa);
	dsi_generic_write_seq(dsi, 0xbd, 0x02);
	dsi_generic_write_seq(dsi, 0xd8,
	...
	dsi_generic_write_seq(dsi, 0xe0,
			      0x00, 0x12, 0x1d, 0x19, 0x39, 0x43, 0x50, 0x4a,
			      0x51, 0x5a, 0x5f, 0x63, 0x66, 0x6d, 0x74, 0x78,
			      0x7c, 0x85, 0x89, 0x95, 0x8c, 0x9e, 0xa5, 0x58,
			      0x55, 0x60, 0x6c, 0x00, 0x12, 0x1d, 0x19, 0x39,
			      0x43, 0x50, 0x4a, 0x51, 0x5a, 0x5f, 0x63, 0x66,
			      0x6d, 0x74, 0x78, 0x7c, 0x85, 0x89, 0x95, 0x8c,
			      0x9e, 0xa5, 0x58, 0x55, 0x60, 0x6c);
	dsi_generic_write_seq(dsi, 0xcc, 0x08);
	dsi_generic_write_seq(dsi, 0xb6, 0x74, 0x74);
	dsi_generic_write_seq(dsi, 0xd2, 0x33);
...
static int hx8399c_auo_53_remove(struct mipi_dsi_device *dsi)
{
